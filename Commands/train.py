...
@click.option('--force', is_flag=True, default=False, help="If a sector doesn't appear in the yaml file for the family classifications, it forces the selection of hyperparameters for this sector.", required=False, type=bool)
@click.option('--n_jobs', prompt="Number of jobs (for grid dearch)", default=10, help='Number of jobs in the parallelization of the hyperparameters search.', type=int, required=False)
